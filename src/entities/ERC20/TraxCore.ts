...
export class TraxCore__decodeOrderResult {
  value0: Address;
  value1: Address;
  value2: Address;
  value3: Address;
...
export class TraxCore extends SmartContract {
  static bind(address: Address): TraxCore {
    return new TraxCore("TraxCore", address);
  }
  ...
  decodeOrder(_data: Bytes): TraxCore__decodeOrderResult {
    let result = super.call("decodeOrder", [EthereumValue.fromBytes(_data)]);

    return new TraxCore__decodeOrderResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toAddress(),
  ...
  try_decodeOrder(_data: Bytes): CallResult<TraxCore__decodeOrderResult> {
    ...
    return CallResult.fromValue(
      new TraxCore__decodeOrderResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toAddress(),
